...
const XIcon = () =>
  h("svg", { width: "15", height: "16", viewBox: "0 0 1200 1227" }, [
    h("path", {
...
const playgroundCode = computed(
  () =>
    `<BorderBeam size="${playgroundSize.value}" colorVariant="${playgroundColorVariant.value}" :duration="${playgroundDuration.value}"${playgroundStrength.value < 100 ? ` :strength="${playgroundStrength.value / 100}"` : ""}>\n  <Card>Content</Card>\n</BorderBeam>`,
);
